...
function testtheme_scripts()
{
	...
	wp_enqueue_style('testtheme-main', get_template_directory_uri() . '/css/main.css');
	...
	wp_enqueue_script('testtheme-script', get_template_directory_uri() . '/js/script.js', array('jquery'));
