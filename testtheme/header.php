...
<div id="page" class="site">
				...
				<div class="col-md-4">
					...
					<ul class="announcement-bar__list">
						<li>
							...
							<a href="tel: +381 60 201 111" class="text-decoration-none">+381 60 201 111</a>
						</li>
						<li>
							<i class="bi bi-envelope rounded-circle"></i>
							<a href="mailto: hello@test.com" class="text-decoration-none">hello@test.com</a>
						</li>
					</ul>
	...
	<header id="masthead" class="site-header">
		...
		<nav id="site-navigation" class="main-navigation bg-icon-background">
				...
				<div class="row">
					<div class="col-12 d-flex justify-content-center">
						<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
							...
							<?php esc_html_e( 'Primary Menu', 'testtheme' ); ?>
						</button>
					</div>
